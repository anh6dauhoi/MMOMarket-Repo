...
public interface NotificationRepository extends JpaRepository<Notification, Long> {
    ...
    @Query("SELECT n FROM Notification n WHERE n.user.email = :email AND (LOWER(n.title) LIKE LOWER(CONCAT('%', :search, '%')) OR LOWER(n.content) LIKE LOWER(CONCAT('%', :search, '%'))) ORDER BY n.createdAt DESC")
    ...
    @Query("SELECT n FROM Notification n WHERE n.user.email = :email AND n.status = :status AND (LOWER(n.title) LIKE LOWER(CONCAT('%', :search, '%')) OR LOWER(n.content) LIKE LOWER(CONCAT('%', :search, '%'))) ORDER BY n.createdAt DESC")
